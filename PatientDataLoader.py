# This class is downloaded from https://github.com/danicaxiao/CONTENT/blob/master/patient_data_reader.py
import os
import itertools
import numpy as np
import math
...
class Data_Loader(object):
    ...
    # this loads the pkl files created from dataprep
    # store the pkl files to X_train, X_valid, X_test
    def _load(self):
    ...
    def get_data_from_type(self, data_type):
        if data_type == "train":
            ...
            raise Exception(" [!] Unknown data type %s: %s" % data_type)
